package GARTApiV1SubmodelBomComponent;
...
public class SubmodelBomController extends abstractController{
	...
	public List<String> getParents(String aasServerAddress, String aasId,String smIdShort) {
		return convertJsonArrayToList(getRelationInfo(aasServerAddress, aasId, smIdShort, ISPARTOF));
	}

	public List<String> getChilds(String aasServerAddress, String aasId,String smIdShort) {
		return convertJsonArrayToList(getRelationInfo(aasServerAddress, aasId, smIdShort, HASPART));
	}
	...
	private JsonArray getRelationInfo(String aasServerAddress, String aasId,String smIdShort, String relationInfo) {
		...
		String entryNodeStr = aasServerGate.getSubmodelElement(aasServerAddress, aasId, smIdShort, smEleList);
		JsonObject entryNode = new Gson().fromJson(entryNodeStr, JsonObject.class);
