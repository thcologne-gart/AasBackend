...
public class BaSyxAasServerGate extends BaSyxGate {
	...
	public String getAasByIdentifier(String aasServeraddress, String identifier) {
		...
		String aas = httpGetCommand(getCommandStr); 
		return aas; 
	}
	
	public String getSubmodelElement(String aasServeraddress, String aasIdentifier, String submodelIdShort, ArrayList<String> submodelElementIdShorts) {
		String str = ""; 
	...
	public JsonObject getSubmodelValues(String aasServeraddress, String aasId, String smIdShort) {
		aasId = aasId.replaceAll(Slash, EncodedSlash);
